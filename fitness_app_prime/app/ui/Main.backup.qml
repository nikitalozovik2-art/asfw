...
ApplicationWindow {
  ...
  // Global technique modal controller
  function showTechnique(title, meta) {
    techniqueModal.openFor(title, meta)
  }
  ...
  Rectangle {
    ...
    RowLayout {
      ...
      Sidebar {
        ...
        onNavigate: function(i) { stack.currentIndex = Math.min(i, stack.count - 1) }
      }
    ...
    // Fullscreen technique modal (overlays the whole app)
    TechniqueModal {
      id: techniqueModal
      anchors.fill: parent
    }
